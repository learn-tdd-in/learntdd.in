...
* [Outside-In Frontend Development in React][outsideindev] - a free online book walking through this style of TDD in React for the web. Technical details are different for React Native but the approach is the same.
...
If you have any questions or suggestions, reach out to <tdd@codingitwrong.com> or any contact mechanism on [codingitwrong.com](https://codingitwrong.com) and we'll be glad to help!
